    ...
    <div class="flex w-full h-full divide-x-2 overflow-y-hidden">
      <div class="flex flex-col w-1/3 h-full gap-y-5 pr-2">
        ...
        <div class="flex flex-col w-full h-1/4 border border-slate-200 rounded-xl p-3 place-items-center gap-y-3">
                    ...
                    ></textarea>
          <Button text="Add" @btnClick="add_emotions" class="h-fit w-fit"/>
        </div>
      </div>
      ...
      <div class="flex flex-col w-2/3 h-full gap-y-5 pl-2">
        ...
        <div class="flex w-full h-1/4">
          <div class="flex w-full border-black border rounded-xl border-dashed p-5 justify-center items-center
            ...
            <input type="file" ref="ai_dataset_file" class="hidden" @change="select_file">
...
import {mdiFileUpload, mdiFolderOpen, mdiHelpCircleOutline, mdiTranslate} from "@mdi/js";
import {ref} from "vue";
