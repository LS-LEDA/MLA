<template>
  <!-- Interactions Card  -->
  <div
    class='flex w-full h-full bg-secondary dark:bg-dark_secondary rounded-3xl p-10 mt-5 hover:cursor-pointer filter drop-shadow-lg transform transition duration-500'
    @click='show_details'
  >
    <!-- Card Information -->
    <div
      class='flex flex-col w-full text-center lg:text-left lg:w-5/12 justify-self-center self-center space-y-3'
    >
