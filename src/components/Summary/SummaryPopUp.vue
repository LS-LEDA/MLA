<template>
    <div class="flex flex-col absolute w-full h-full justify-center place-items-center z-40 bg-gray-400 bg-opacity-75 transition-opacity"
        ...
        <div class="flex flex-col bg-secondary w-11/12 h-5/6 rounded-xl z-50 p-5 gap-y-5">
            <div class="flex w-full justify-between">
                <!-- PopUp Title -->
                <div class="w-auto bg-primary_variant rounded-xl py-2 px-5 font-bold">
                    {{ card_name }}
                </div>
                <!-- Close button -->
            ...
            <div v-else class="flex w-full max-h-full justify-center overflow-y-scroll">
                <table class="table-auto">
                    <thead class="bg-primary_variant">
                    ...
                    <tbody>
                    <tr class="bg-primary hover:bg-primary_variant" v-for="(interaction, index) in summary_interactions" :key="index">
