<template>
    <div class="flex flex-col absolute inset-0 justify-center place-items-center bg-gray-400 bg-opacity-75 transition-opacity"
        ...
        <div class="flex flex-col bg-primary dark:bg-dark_primary w-3/6 h-4/6 rounded-3xl z-50">
            ...
            <button class="self-center bg-primary dark:bg-dark_primary hover:bg-primary_variant dark:hover:bg-dark_primary_variant rounded-lg font-bold py-3 w-1/6 h-1/10" @click="hidePopUp">EXIT</button>
        </div>
