<template>
  <div
    class='flex w-full rounded-lg h-fit bg-primary dark:bg-dark_primary place-items-center p-5 gap-x-3'
  >
    ...
    <div v-if='grid' class='flex flex-col w-full'>
      <span class='truncate text-ellipsis whitespace-nowrap font-bold'>
        {{ name }}
      </span>
      <!-- Student Name -->
